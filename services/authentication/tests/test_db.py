...
class TestDb(TestCase):
    ...
    def test_create_user_with_valid_user_schema(self):
        ...
        db_user = self.events.get_user_by_username(
            db=self.db, username=self.sample_username
        )
